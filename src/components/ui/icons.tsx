/** Inline icons (no dependencies). Thin stroke, consistent with the minimalist aesthetic. */
...
export function Quote(p: IconProps) {
  return (
    <svg {...base} {...p} fill="currentColor" stroke="none">
      <path d="M9.5 8C7 8 5 10 5 12.5c0 2.2 1.6 3.8 3.6 3.8 1.2 0 1.5-.3 1.5.3 0 1-1 2.4-2.6 3l.8 1.4c2.8-1 4.7-3.6 4.7-7C13 9.7 11.5 8 9.5 8zm9 0c-2.5 0-4.5 2-4.5 4.5 0 2.2 1.6 3.8 3.6 3.8 1.2 0 1.5-.3 1.5.3 0 1-1 2.4-2.6 3l.8 1.4c2.8-1 4.7-3.6 4.7-7C22 9.7 20.5 8 18.5 8z" />
    </svg>
  );
}
