...
`Clínica de fisioterapia en Tres Cantos: valoración, tratamiento y ejercicio terapéutico. Hasta las 22:00 de lunes a viernes y sábados por la mañana.`

*El título de los cuatro competidores que mejor posicionan dice exactamente lo mismo —«Fisioterapia Tres Cantos» más la marca— y ninguno añade un motivo para pulsar. El nuestro lleva delante la búsqueda exacta y detrás **el par que ninguna otra clínica del municipio puede poner junto**: noche entre semana y sábado. En un listado de diez resultados idénticos, ese trozo de título es la mitad del trabajo.*

*__Corregido el 14/08/2026.__ La primera versión decía solo «también sábados». Se le añade la hora porque el sábado, por sí solo, se lee como «media jornada suelta»; **«hasta las 22 h y sábados» describe una disponibilidad completa**, que es lo que de verdad diferencia. La marca se abrevia a `MUV` para que quepan las dos cosas: en la búsqueda local pesa más la disponibilidad que la palabra «Clínica», que ya va en la meta.*
...
*__Lo que sí se puede decir, y es más fuerte:__ **la combinación no la tiene nadie**. De los once dominios de Tres Cantos, ninguno abre en sábado —cinco lo dicen expresamente («Sábados y domingos: cerrado») y el resto solo publica horario de lunes a viernes—. Motriz llega a las 22:00 pero cierra el fin de semana; quien abre más pronto, Centro Vitruvio a las 7:00, cierra a las 21:00. **Noche entre semana y sábado por la mañana a la vez, solo MUV.***

*Se redacta siempre en primera persona y sin comparar —el documento de arranque lo prohíbe—: se dice el horario propio, se pone donde se ve y el lector compara solo. Va en la entradilla, en la ficha, en el módulo 8 y en `openingHoursSpecification`, que es lo que hace que Google pueda mostrar «Abierto los sábados» en el resultado.*

*__La contrapartida, para MUV, no para la página:__ abrimos a las 10:00 y seis de los once abren antes —Vitruvio a las 7:00, Islas21 a las 8:30—. La franja de antes de entrar a trabajar se cede entera. No se arregla escribiendo, se arregla abriendo, y merece que MUV lo valore.*
...
**H2**
> Dolencias y lesiones que tratamos en Tres Cantos
...
**Las siete tarjetas** — una línea cada una, enlazando a su página de servicio:
...
*__Dos de estos siete no los ofrece nadie más en Tres Cantos con ese nombre:__ el **entrenamiento terapéutico en grupo** —hay clases colectivas y entrenamiento personal en la competencia, pero no grupos pautados por fisioterapeutas después de una valoración— y el **tratamiento de cicatrices**, que no aparece en ninguna de las once webs. El segundo tiene poco volumen de búsqueda, pero no tiene competencia ninguna.*
...
**H2**
> Cómo es la primera sesión de fisioterapia en esta clínica
...
*__Este módulo existe por una razón comercial concreta.__ En Tres Cantos, **Lashmi, ALG Fisio, Fisio 3 Cantos e Islas21 publican tarifas**, y una de ellas anuncia sesiones desde 25 €. MUV ha decidido no publicar precios, y esa decisión se respeta, pero entonces la página tiene que responder a la pregunta que hay debajo del precio: **qué me llevo por lo que pago.** Contar la duración, la valoración, el fisioterapeuta dedicado y el plan de salida hace ese trabajo sin dar una cifra.*

*No repite la metodología de la home, que cuenta el proceso completo de valoración a alta. Esto cuenta un día concreto: el primero.*
...
*__El bloque que más urgía, y el que ninguna ventaja da ya.__ La auditoría anterior daba por hecho que nadie publicaba acreditación. Recomprobado el 14 de agosto de 2026 sobre trece dominios —incluyendo avisos legales y páginas de equipo, que es donde estaba escondido—, **es falso**: publican su registro sanitario **Motriz (`CS20487`)**, **ALG Fisio (`CS11939`)** y **Fisio 3 Cantos (`CS9056`, en el aviso legal)**, y publican el número de colegiado de cada profesional **cinco**: Motriz, ALG, Islas21, Fisio 3 Cantos y FisioSanfe. **Aquí no se gana: se empata. Y mientras no llegue el número de Tres Cantos, se pierde.***

*El inglés sí es hueco libre: de los trece dominios comprobados ninguno ofrece atención en inglés como servicio. En un municipio con unas 800 empresas internacionales es un filtro de búsqueda real, y cuesta una línea.*
...
*__Y el sábado no se pierde por salir de aquí, gana.__ Estaba mejor colocado en la entradilla y en la ficha del hero, donde se ve sin desplegar nada, y sobre todo en `openingHoursSpecification` dentro del `MedicalClinic`. **Ese es el marcado que hace que Google muestre «Abierto los sábados» en el resultado de búsqueda; una `FAQPage` no lo hace.** Estaba en el sitio equivocado.*
...
| **H2** · Dolencias y lesiones que tratamos en Tres Cantos | dolencias + lesiones + municipio | Puerta de entrada por síntoma. Es el H2 de la home más el municipio: misma sección, intención distinta —allí genérica, aquí local—, y es exactamente la diferenciación que `/sedes` dejó fijada. |
| **H3** · Dolor de espalda: lumbar, cervical y dorsal · Lesión de rodilla · Lesión de hombro · ATM y dolor mandibular | 4 dolencias + 3 zonas + síntoma | Los H3 llevan las variantes dentro para capturar «dolor cervical», «dolor lumbar» y «dolor mandibular» sin encabezados de más. Dentro de cada bloque, los cuadros por su nombre —lumbalgia, tendinopatía rotuliana, manguito rotador, bruxismo— hacen la cola larga sin crear páginas. |
...
| **H2** · Cómo es la primera sesión de fisioterapia en esta clínica | primera sesión de fisioterapia | Búsqueda informativa real con intención de compra alta. Sustituye al bloque de precios que aquí no se publica. |
...
- **`FAQPage`** en el módulo 9, con las ocho preguntas.
...
| **Abierto en sábado** | **0** | Hueco real. Entradilla, ficha y `openingHoursSpecification` |
...
| Tarifas publicadas | 5 | No se publican: se responde qué incluye la sesión *(módulo 4)* |
...
4. **Los cuatro datos del módulo 8:** minutos a pie desde la estación, líneas de autobús y parada, dónde aparcar y si el local es accesible. Cuatro líneas que MUV sabe de memoria y que **no publica ninguno de los trece dominios auditados**. Es el pendiente más barato y el más rentable de toda la página.
...
**Para desarrollo**
- La página `/sedes/tres-cantos` hoy tiene 197 palabras de marcador y ninguno de los diez módulos.
